...
@Entity
@Table( name="PLF_USER_ACCESS_TYPE" )
@Cache( usage=CacheConcurrencyStrategy.READ_ONLY )
public class UserAccessType 
    extends AbstractPlatformType {

    private static final long serialVersionUID = 6839008776654293308L;
    
    public static final String OBJECT_TYPE_TREE_CODE = "ROOT";
    
    public static final String OBJECT_TYPE_NAME = "User Access Type";
