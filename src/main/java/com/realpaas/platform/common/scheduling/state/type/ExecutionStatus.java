 ...
 * @see			
 */
public enum ExecutionStatus implements ByteEnumType<ExecutionStatus>{
    
    Running( Byte.valueOf((byte)0), "scheduling.runing", "Running"), 
    Successful( Byte.valueOf((byte)1), "scheduling.successful", "Successful"),
    Failed( Byte.valueOf((byte)2), "scheduling.failed", "Failed");
    ...
    private ExecutionStatus(byte value, String key, String displayName) {
        this.value = value;
        this.key = key;
     ...
     */
    private static final Map<Byte, ExecutionStatus> valueToEnum = new HashMap<Byte, ExecutionStatus>();
    
    /**
     * Initialize map from constant name to enum constant
     */
    static {
        for(ExecutionStatus enumInstance : values()) {
     ...
     * @return
     */
    public static ExecutionStatus fromValue(Byte value) {
