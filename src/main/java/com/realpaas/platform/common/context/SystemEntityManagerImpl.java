...
public class SystemEntityManagerImpl implements SystemEntityManager {
    ...
    public SystemEntity load(String code) {
        com.realpaas.platform.core.infras.dataobject.SystemEntity entry =  systemEntityService.loadByCode( code );
        if( entry==null ){
            return null;
        }
        else{
    ...
    public void create(SystemEntity systemEntity) {
        com.realpaas.platform.core.infras.dataobject.SystemEntity dataobject = new com.realpaas.platform.core.infras.dataobject.SystemEntity();
    ...
    public void mutate(SystemEntity systemEntity) {
        com.realpaas.platform.core.infras.dataobject.SystemEntity entry = systemEntityService.loadByCode( systemEntity.getCode() );
