 ...
 */
@Repository( "fileStorageStrategyDao" )
public class FileStorageStrategyDaoImpl extends PlatformTypeDaoTemplate<FileStorageStrategy> implements FileStorageStrategyDao {
