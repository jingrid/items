 ...
 */
package com.realpaas.platform.core.infras.service;

import com.realpaas.platform.core.infras.dataobject.SystemEntity;
import com.realpaas.platform.framework.service.GenericService;
 ...
 * </dd>
 * <dd>
 * 	Aug 5, 2012	henryleu	Create the class
 * </dd>
 * 
 * </dl>
...
public interface SystemEntityService
    extends 
        ServiceLoadingByCode<SystemEntity>,
        ServiceDeletingAll,
        GenericService<SystemEntity>{
