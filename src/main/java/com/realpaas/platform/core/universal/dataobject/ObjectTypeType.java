 ...
 */
@Entity
@Table(name="PLF_OBJECT_TYPE_TYPE")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)
public class ObjectTypeType extends AbstractPlatformType{

    private static final long serialVersionUID = -2180220455798073345L;
