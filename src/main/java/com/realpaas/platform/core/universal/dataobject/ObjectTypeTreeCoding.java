 ...
 */
public interface ObjectTypeTreeCoding {
    
    public static final String PROP_OBJECT_TYPE_TREE_CODE = "objectTypeTreeCode";
    
    public static final String CLMN_OBJECT_TYPE_TREE_CODE = "OBJECT_TYPE_TREE_CODE";
