...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../common/resources/css/App.css">
    <style>
        table,tr,td,th {
    ...
    <script type="text/javascript" src="../../common/resources/jquery/script/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="../../common/resources/jquery/script/jquery.cookie.js"></script>
    <script type="text/javascript" src="../../common/resources/rui/js/rui.js"></script>
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.cookieItemRemove').click(function(){
                ...
                $.removeCookie( name, Rui.cookieOptions );
                refreshPage();
            });
            ...
            $('.cookieItemUpdate').click(function(){
                ...
                $.cookie( name, newValue, Rui.cookieOptions );
                refreshPage();
            });
